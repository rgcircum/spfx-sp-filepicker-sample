...
export interface IFilePickerOptions {
    ...
    theme?: 'default' | 'dark' | 'lists' | 'teams' | 'teams-default' | 'teams-dark' | 'teams-contrast' | ITheme;
...
export interface PickerChangeEvent extends Event {
    detail: IPickData;
}

export interface PickerNotificationEvent extends Event {
    detail: INotificationData;
}

export interface PickerWindowEventMap {
    'pickerchange': PickerChangeEvent;
    'pickernotification': PickerNotificationEvent;
}
